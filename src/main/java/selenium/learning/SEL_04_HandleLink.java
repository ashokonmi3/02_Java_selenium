...
// Step1 : Collect all the hyper links present in the webpage 
//          the hyper links will have anchor tag <a>
...
//		String[] linkTexts = new String[linkElements.size()];// created to store the link text of each <a> tag element
//		int i = 0;
//
